//will show all the domains owned by the currently logged in user, and they can click on any of them to go to manage/[nameHash].js where we will let them update the Bio, Address, or Renew the Domain.
